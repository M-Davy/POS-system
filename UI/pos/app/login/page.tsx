    ...
    <div className="min-h-screen bg-gray-900 fixed inset-0 overflow-hidden">
      <div className="w-full h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
          ...
          <div className="relative bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-800 p-8 lg:p-12 flex flex-col">
            {/* Decorative elements */}
            ...
            <div className="relative z-10 mt-auto">
              <div className="relative h-48 lg:h-56 rounded-2xl overflow-hidden shadow-2xl border-2 border-white/20">
                <Image 
          ...
          <div className="bg-gray-900 p-10 lg:p-14 flex flex-col justify-center overflow-y-auto">
